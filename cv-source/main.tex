...
\begin{onecolentry}
\begin{highlights}
	\item Developed and taught undergraduate course "Introduction to Chemistry" (co-authored course textbook) 
	...
	\item Supervised 20 thesis projects on MOFs and luminescent materials; 14 students continued to graduate programs
\end{highlights}
\end{onecolentry}
\end{document}
